...
class form5Controller extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/form5')->with('status', 'Student registered successfully!');
    ...
    public function update(Request $request, form5 $form5)
    {
        ...
        // Redirect or respond with success message
        return redirect('/form5')->with('status', 'Student Updated successfully!');
    ...
    {
        $form5->delete();
        return redirect('/form5')->with('status','Student Deleted Successfully');
    }
}
