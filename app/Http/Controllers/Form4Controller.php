...
class form4Controller extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/form4')->with('status', 'Student registered successfully!');
    ...
    public function update(Request $request, form4 $form4)
    {
        ...
        // Redirect or respond with success message
        return redirect('/form4')->with('status', 'Student Updated successfully!');
    ...
    {
        $form4->delete();
        return redirect('/form4')->with('status','Student Deleted Successfully');
    }
}
