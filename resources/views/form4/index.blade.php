                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($form4s as $form4)
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->id }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->name }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->date }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->gender }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->region }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->dioces }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->nation }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->address }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->phone }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->email }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap"> {{ $form4->photo }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->parname }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->parphone }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->paremail }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->emergencephone }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->health }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form4->disability }}</td>


                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex space-x-2">
                                                 <!-- Edit Link -->
<a href="{{ route('form4.edit', $form4->id) }}"
...
<!-- Delete Link -->
<form action="{{ route('form4.destroy', $form4->id) }}" method="POST" class="inline">
   @csrf
   @method('DELETE')
