            ...
            <div class="col mb-22">
                <div class="bg-white shadow-md rounded-lg overflow-hidden">
                    <div class="bg-gray-200 p-4 flex items-center justify-between">
                        <h4 class="text-lg font-semibold">Form Three Records</h4>
                        <a href="{{ url('form6/create') }}"
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($form6s as $form6)
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->id }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->name }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->date }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->gender }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->region }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->dioces }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->nation }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->address }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->phone }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->email }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap"> {{ $form6->photo }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->parname }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->parphone }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->paremail }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->emergencephone }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->health }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form6->disability }}</td>


                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex space-x-2">
                                                 <!-- Edit Link -->
<a href="{{ route('form6.edit', $form6->id) }}"
...
<!-- Delete Link -->
<form action="{{ route('form6.destroy', $form6->id) }}" method="POST" class="inline">
   @csrf
   @method('DELETE')
