                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($form3s as $form3)
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->id }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->name }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->date }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->gender }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->region }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->dioces }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->nation }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->address }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->phone }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->email }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap"> {{ $form3->photo }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->parname }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->parphone }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->paremail }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->emergencephone }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->health }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form3->disability }}</td>


                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex space-x-2">
                                                 <!-- Edit Link -->
<a href="{{ route('form3.edit', $form3->id) }}"
...
<!-- Delete Link -->
<form action="{{ route('form3.destroy', $form3->id) }}" method="POST" class="inline">
   @csrf
   @method('DELETE')
