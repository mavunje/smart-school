                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($form5s as $form5)
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->id }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->name }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->date }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->gender }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->region }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->dioces }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->nation }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->address }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->phone }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->email }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap"> {{ $form5->photo }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->parname }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->parphone }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->paremail }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->emergencephone }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->health }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $form5->disability }}</td>


                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex space-x-2">
                                                 <!-- Edit Link -->
<a href="{{ route('form5.edit', $form5->id) }}"
...
<!-- Delete Link -->
<form action="{{ route('form5.destroy', $form5->id) }}" method="POST" class="inline">
   @csrf
   @method('DELETE')
