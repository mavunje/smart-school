...
@section('content')
    ...
    @php
        ...
        $permissionGender = App\Models\PermissionRoleModel::getPermission('Gender management', Auth::user()->role_id);
        $permissionResource = App\Models\PermissionRoleModel::getPermission('Human resource', Auth::user()->role_id);
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card revenue-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">REGISTERED TODAY</span></h5>
                        ...
                        <div class="col-xxl-4 col-xl-12">
                            ...
                            <div class="card info-card customers-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">REGISTERED IN YEAR</h5>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Registration History</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    @foreach ($registrationRates as $rate)
                                        <h6> {{ $rate['day'] }}</h6>
                                        <p> <b>Total registered to this day</b>
                                        <h6>{{ $rate['registrations'] }}</h6>
                                        </p>

                                        <h6>{{ $rate['percentage'] }}% </h6>
                                        <hr>
                                    @endforeach
                                </div>
